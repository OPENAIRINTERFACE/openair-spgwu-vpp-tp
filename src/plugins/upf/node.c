/*
 * node.c - 3GPP TS 29.244 GTP-U UP plug-in dual-loop node skeleton
 *
...
static u8 *
format_upf_trace (u8 * s, va_list * args)
{
...
#undef _
	  ...
	  if (PREDICT_FALSE ((node->flags & VLIB_NODE_FLAG_TRACE)))
		...
		{
		  upf_trace_t *t = vlib_add_trace (vm, node, b0, sizeof (*t));
		...
		{
		  upf_trace_t *t = vlib_add_trace (vm, node, b1, sizeof (*t));
